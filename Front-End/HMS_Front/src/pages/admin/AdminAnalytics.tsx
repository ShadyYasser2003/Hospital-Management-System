  ...
  return (
    <DashboardLayout navItems={adminNavItems} title="Analytics Dashboard">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <StatCard title="Total Patients"        value={patients.length}              icon={<Users className="h-6 w-6" />}       variant="primary" />
        <StatCard title="Total Appointments"    value={appointments.length}          icon={<Calendar className="h-6 w-6" />}    variant="accent" />
        <StatCard title="Today's Appointments"  value={stats.todayAppointments}      icon={<Calendar className="h-6 w-6" />}    variant="success" />
        <StatCard title="Total Prescriptions"   value={prescriptions.length}         icon={<FileText className="h-6 w-6" />}    variant="warning" />
      </div>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <StatCard title="Dispensed Rx"     value={stats.dispensedRx}           icon={<Pill className="h-6 w-6" />}       variant="primary" />
        <StatCard title="Total Invoices"   value={invoices.length}             icon={<FlaskConical className="h-6 w-6" />} variant="accent" />
      </div>
