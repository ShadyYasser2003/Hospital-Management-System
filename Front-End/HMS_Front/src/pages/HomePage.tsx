      ...
      <header className="sticky top-0 z-50 border-b border-border bg-card/90 backdrop-blur-sm">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-base font-bold leading-none">HealthCare HMS</p>
      ...
      <section className="py-20 px-4 bg-primary">
        <div className="container mx-auto text-center">
          ...
          <p className="text-primary-foreground/80 max-w-xl mx-auto mb-10">
            Join thousands of healthcare professionals using HealthCare HMS to deliver better care, faster.
          </p>
      ...
      <footer id="contact" className="bg-[hsl(var(--sidebar-background))] text-[hsl(var(--sidebar-foreground))] pt-16 pb-8 px-4">
        <div className="container mx-auto">
          <div className="grid md:grid-cols-3 gap-10 mb-12">
            ...
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="font-bold text-lg">HealthCare HMS</span>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-[hsl(var(--sidebar-foreground)/0.7)]">
                ...
                <li className="flex items-center gap-2"><Mail className="h-4 w-4 text-primary shrink-0" /> info@healthcarehms.com</li>
          ...
          <div className="border-t border-[hsl(var(--sidebar-border))] pt-6 text-center text-xs text-[hsl(var(--sidebar-foreground)/0.4)]">
            © {new Date().getFullYear()} HealthCare Hospital Management System. All rights reserved.
          </div>
        </div>
      </footer>
