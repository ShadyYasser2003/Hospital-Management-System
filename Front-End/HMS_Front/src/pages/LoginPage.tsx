...
const LoginPage = () => {
  ...
  const validateForm = () => {
    ...
    if (!usernameOrId.trim()) {
      newErrors.username = isPatientPortal ? 'Username or National ID is required' : 'Staff username is required';
    }
    if (!password) {
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              <Label htmlFor="usernameOrId" className="text-sm font-medium">
                {isPatientPortal ? 'Username or National ID' : 'Staff Username'}
              </Label>
              <div className="relative">
                ...
                <Input
                  ...
                  placeholder={isPatientPortal ? 'Enter username or national ID' : 'Enter staff username'}
