        ...
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div><Label>Date of Birth</Label><Input type="date" value={editFormData.dateOfBirth} onChange={(e) => setEditFormData({ ...editFormData, dateOfBirth: e.target.value })} /></div>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div>
                <Label>Gender</Label>
              ...
              <div>
                ...
                <Select value={editFormData.bloodType} onValueChange={(v) => setEditFormData({ ...editFormData, bloodType: v })}>
