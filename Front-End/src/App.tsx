...
import DoctorTransfer from "./pages/doctor/DoctorTransfer";
...
import TechnicianBloodBank from "./pages/technician/TechnicianBloodBank";
      ...
      <AuthProvider>
          ...
          <BrowserRouter>
            <Routes>
              ...
              <Route path="/doctor/transfers" element={<ProtectedRoute allowedRoles={['doctor']}><DoctorTransfer /></ProtectedRoute>} />
              ...
              <Route path="/doctor/blood-bank" element={<ProtectedRoute allowedRoles={['doctor']}><DoctorBloodRequests /></ProtectedRoute>} />
              ...
              <Route path="/nurse/notifications" element={<ProtectedRoute allowedRoles={['nurse']}><NurseNotifications /></ProtectedRoute>} />
              ...
              <Route path="/pharmacist/notifications" element={<ProtectedRoute allowedRoles={['pharmacist']}><PharmacistNotifications /></ProtectedRoute>} />
              ...
              <Route path="/technician/blood-bank" element={<ProtectedRoute allowedRoles={['technician']}><TechnicianBloodBank /></ProtectedRoute>} />
