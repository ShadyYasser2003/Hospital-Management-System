...
const DashboardLayout: React.FC<DashboardLayoutProps> = ({ children, navItems, title }) => {
  ...
  useWebSocketNotifications(user?.id, token);
  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          >
            <div className="p-4 border-b border-sidebar-border">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="font-bold">MediCore</h2>
      ...
      {/* AI Chatbot - Patient and Doctor */}
      {user?.role === 'patient' && <AIChatbot role="patient" />}
      {user?.role === 'doctor'  && <AIChatbot role="doctor" />}
    </div>
  );
};
