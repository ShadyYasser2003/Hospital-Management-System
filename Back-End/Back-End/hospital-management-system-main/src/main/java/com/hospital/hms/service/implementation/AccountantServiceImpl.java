...
public class AccountantServiceImpl implements AccountantService {
    ...
    public AccountantDto createAccountant(AccountantDto dto) {
        // Check both accountants table and users table for duplicates
        ...
        Accountant saved = accountantRepository.save(a);
        log.info("Accountant created: {}", saved.getId());
        return AccountantMapper.mapToDto(saved);
    }
